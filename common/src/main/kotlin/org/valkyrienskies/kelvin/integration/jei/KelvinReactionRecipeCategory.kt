...
class KelvinReactionRecipeCategory(private val guiHelper: IGuiHelper) : IRecipeCategory<GasBaseRecipe> {
    ...
    private val arrow: IDrawable by lazy { SpriteDrawable(ARROW_WIDTH, ARROW_HEIGHT, FURNACE_SHEET, ARROW_U, ARROW_V) }
    ...
    private companion object {
        ...
        val FURNACE_SHEET: ResourceLocation = ResourceLocation("textures/gui/container/furnace.png")
        // Filled burn-progress arrow, as blitted by AbstractFurnaceScreen.renderBg in 1.20.1.
        const val ARROW_U = 176
        const val ARROW_V = 14
