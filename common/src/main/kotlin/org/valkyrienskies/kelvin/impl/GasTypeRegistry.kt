...
object GasTypeRegistry {
    ...
    fun init () {
        val air = GasType("Air", 1.293, 1.716e-5, 1.005, 0.026)
        val phlogiston = GasType("Phlogiston", 3.0, 2.0e-5, 14.30, 0.240, 150.0, 1.008, true, 3.5e+8)
        val helium = GasType("Helium",0.166, 1.96e-5, 5.1832, 0.151, 79.4, 1.66)
        val hydrogen = GasType("Hydrogen", 0.08988, 0.88e-5, 14.30, 0.18, 72.0, 1.4, true, 1.418e+8)
        val methane = GasType("Methane", 0.657, 1.10e-5, 2.2, 0.031, 90.0, 16.0, true, 5.55e+7)
